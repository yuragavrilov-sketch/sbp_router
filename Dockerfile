...
# Trust the corporate CA chain so HTTPS calls validate (Vault, infosrv, corp git). The CA PEM is
# placed in certs/ by the CI docker_build (from the $CERT variable). Each file may hold a full
